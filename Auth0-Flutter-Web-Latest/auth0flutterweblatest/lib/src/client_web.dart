...
class B2CAuthWeb implements B2CAuth {
  ...
  //final clientId = '8Vq0qG2dlceK7BB2Pe6vTeKaz34J5XTN';
  ...
  Future<AuthorizationTokenResponse> processStartup() async {
    ...
    AuthorizationTokenRequest _request = AuthorizationTokenRequest(clientId, redirectUrl, issuer: 'https://$domain', scopes: scopes);
